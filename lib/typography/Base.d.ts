...
declare class Base extends React.Component<InternalBlockProps, BaseState> {
    ...
    syncEllipsis(): void;
    renderExpand(forceRender?: boolean): React.JSX.Element | null;
    renderEdit(): React.JSX.Element | undefined;
    renderCopy(): React.JSX.Element | undefined;
    renderEditInput(): React.JSX.Element;
    renderOperations(forceRenderExpanded?: boolean): (React.JSX.Element | null | undefined)[];
