...
declare class Select<ValueType extends SelectValue = SelectValue> extends React.Component<SelectProps<ValueType>> {
    ...
    focus: () => void;
    blur: () => void;
    getMode: () => "multiple" | "combobox" | "tags" | "SECRET_COMBOBOX_MODE_DO_NOT_USE" | undefined;
    renderSelect: ({ getPopupContainer: getContextPopupContainer, getPrefixCls, renderEmpty, direction, virtual, dropdownMatchSelectWidth, }: ConfigConsumerProps) => React.JSX.Element;
