...
var Search = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var renderSearch = function renderSearch(_ref) {
    ...
    var getClassName = function getClassName(size) {
      var inputClassName;
      if (enterButton) {
        inputClassName = (0, _classnames["default"])(prefixCls, (0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])({}, "".concat(prefixCls, "-rtl"), direction === 'rtl'), "".concat(prefixCls, "-enter-button"), !!enterButton), "".concat(prefixCls, "-").concat(size), !!size), className);
      } else {
