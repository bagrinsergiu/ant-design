...
function FormItem(props) {
  ...
  var _useContext3 = (0, _react.useContext)(_context.FormItemContext),
  ...
  var _useContext4 = (0, _react.useContext)(_FieldContext["default"]),
  ...
  function renderLayout(baseChildren, fieldId, meta, isRequired) {
    ...
    var itemClassName = (0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])({}, "".concat(prefixCls, "-item"), true), "".concat(prefixCls, "-item-with-help"), domErrorVisible || help), "".concat(className), !!className), "".concat(prefixCls, "-item-has-feedback"), mergedValidateStatus && hasFeedback), "".concat(prefixCls, "-item-has-success"), mergedValidateStatus === 'success'), "".concat(prefixCls, "-item-has-warning"), mergedValidateStatus === 'warning'), "".concat(prefixCls, "-item-has-error"), mergedValidateStatus === 'error'), "".concat(prefixCls, "-item-is-validating"), mergedValidateStatus === 'validating'), "".concat(prefixCls, "-item-hidden"), hidden);
    // ======================= Children =======================
    return /*#__PURE__*/React.createElement(_row["default"], (0, _extends3["default"])({
      className: (0, _classnames["default"])(itemClassName),
      style: style,
      key: "row"
    }, (0, _omit["default"])(restProps, ['colon', 'extra', 'getValueFromEvent', 'getValueProps', 'hasFeedback', 'help', 'htmlFor', 'id', 'initialValue', 'isListField', 'label', 'labelAlign', 'labelCol', 'normalize', 'preserve', 'required', 'tooltip', 'validateFirst', 'validateStatus', 'valuePropName', 'wrapperCol'])), /*#__PURE__*/React.createElement(_FormItemLabel["default"], (0, _extends3["default"])({
      htmlFor: fieldId,
      required: isRequired,
