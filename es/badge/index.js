...
var Badge = function Badge(_a) {
  ...
  var renderBadgeNumber = function renderBadgeNumber() {
    ...
    var bDot = isDot();
    var hidden = isHidden();
    var scrollNumberCls = classNames(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-dot"), bDot), "".concat(prefixCls, "-count"), !bDot), "".concat(prefixCls, "-count-sm"), size === 'small'), "".concat(prefixCls, "-multiple-words"), !bDot && count && count.toString && count.toString().length > 1), "".concat(prefixCls, "-status-").concat(status), !!status), "".concat(prefixCls, "-status-").concat(color), isPresetColor(color)));
