...
declare class TreeSelect<T> extends React.Component<TreeSelectProps<T>, {}> {
    ...
    focus(): void;
    blur(): void;
    renderTreeSelect: ({ getPopupContainer: getContextPopupContainer, getPrefixCls, renderEmpty, direction, virtual, dropdownMatchSelectWidth, }: ConfigConsumerProps) => React.JSX.Element;
