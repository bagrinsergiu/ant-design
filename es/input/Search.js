...
var Search = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var renderSearch = function renderSearch(_ref) {
    ...
    var getClassName = function getClassName(size) {
      var inputClassName;
      if (enterButton) {
        inputClassName = classNames(prefixCls, _defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-rtl"), direction === 'rtl'), "".concat(prefixCls, "-enter-button"), !!enterButton), "".concat(prefixCls, "-").concat(size), !!size), className);
      } else {
