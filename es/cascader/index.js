...
var Cascader = /*#__PURE__*/function (_React$Component) {
  function Cascader(props) {
    ...
    _this.renderCascader = function (_ref2, locale) {
      ...
      return /*#__PURE__*/React.createElement(SizeContext.Consumer, null, function (size) {
        ...
        var sizeCls = classNames(_defineProperty(_defineProperty({}, "".concat(inputPrefixCls, "-lg"), mergedSize === 'large'), "".concat(inputPrefixCls, "-sm"), mergedSize === 'small'));
        ...
        var arrowCls = classNames(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-picker-arrow"), true), "".concat(prefixCls, "-picker-arrow-expand"), state.popupVisible));
        var pickerCls = classNames("".concat(prefixCls, "-picker"), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-picker-rtl"), isRtlLayout), "".concat(prefixCls, "-picker-with-value"), state.inputValue), "".concat(prefixCls, "-picker-disabled"), disabled), "".concat(prefixCls, "-picker-").concat(mergedSize), !!mergedSize), "".concat(prefixCls, "-picker-show-search"), !!showSearch), "".concat(prefixCls, "-picker-focused"), inputFocused), "".concat(prefixCls, "-picker-borderless"), !bordered), className);
        ...
        if (options && options.length > 0) {
          ...
          options = [_defineProperty(_defineProperty({}, names.label, notFoundContent || renderEmpty('Cascader')), names.value, 'ANT_CASCADER_NOT_FOUND')];
        }
        ...
        if (suffixIcon) {
          inputIcon = replaceElement(suffixIcon, /*#__PURE__*/React.createElement("span", {
            ...
            return {
              className: classNames(_defineProperty(_defineProperty({}, suffixIcon.props.className, suffixIcon.props.className), "".concat(prefixCls, "-picker-arrow"), true))
            };
          });
        } else {
        ...
        var rcCascaderPopupClassName = classNames(popupClassName, _defineProperty(_defineProperty({}, "".concat(prefixCls, "-menu-").concat(direction), direction === 'rtl'), "".concat(prefixCls, "-menu-empty"), options.length === 1 && options[0].value === 'ANT_CASCADER_NOT_FOUND'));
  ...
  return _createClass(Cascader, [{
    ...
    value: function generateFilteredOptions(prefixCls, renderEmpty) {
      ...
      return [_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, names.value, 'ANT_CASCADER_NOT_FOUND'), names.label, notFoundContent || renderEmpty('Cascader')), "disabled", true), "isEmptyNode", true)];
    }
  }, {
    key: "focus",
