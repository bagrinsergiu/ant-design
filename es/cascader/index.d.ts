...
declare class Cascader extends React.Component<CascaderProps, CascaderState> {
    ...
    renderCascader: ({ getPopupContainer: getContextPopupContainer, getPrefixCls, renderEmpty, direction, }: ConfigConsumerProps, locale: CascaderLocale) => React.JSX.Element;
