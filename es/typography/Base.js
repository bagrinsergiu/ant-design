    ...
    value: function renderContent() {
      ...
      return /*#__PURE__*/React.createElement(LocaleReceiver, {
        ...
        return /*#__PURE__*/React.createElement(ResizeObserver, {
          ...
          className: classNames(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-").concat(type), type), "".concat(prefixCls, "-disabled"), disabled), "".concat(prefixCls, "-ellipsis"), rows), "".concat(prefixCls, "-ellipsis-single-line"), cssTextOverflow), "".concat(prefixCls, "-ellipsis-multiple-line"), cssLineClamp), className),
