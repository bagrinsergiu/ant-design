    ...
    _this.renderItem = function (_ref) {
      ...
      return /*#__PURE__*/React.createElement(MenuContext.Consumer, null, function (_ref2) {
        ...
        return /*#__PURE__*/React.createElement(Tooltip, _extends({}, tooltipProps, {
          ...
          className: classNames(_defineProperty(_defineProperty({}, "".concat(rootPrefixCls, "-item-danger"), danger), "".concat(rootPrefixCls, "-item-only-child"), (icon ? childrenLength + 1 : childrenLength) === 1), className),
          title: title
