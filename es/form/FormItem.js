...
function FormItem(props) {
  ...
  function renderLayout(baseChildren, fieldId, meta, isRequired) {
    ...
    var itemClassName = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-item"), true), "".concat(prefixCls, "-item-with-help"), domErrorVisible || help), "".concat(className), !!className), "".concat(prefixCls, "-item-has-feedback"), mergedValidateStatus && hasFeedback), "".concat(prefixCls, "-item-has-success"), mergedValidateStatus === 'success'), "".concat(prefixCls, "-item-has-warning"), mergedValidateStatus === 'warning'), "".concat(prefixCls, "-item-has-error"), mergedValidateStatus === 'error'), "".concat(prefixCls, "-item-is-validating"), mergedValidateStatus === 'validating'), "".concat(prefixCls, "-item-hidden"), hidden);
    // ======================= Children =======================
    return /*#__PURE__*/React.createElement(Row, _extends({
      className: classNames(itemClassName),
      style: style,
      key: "row"
    }, omit(restProps, ['colon', 'extra', 'getValueFromEvent', 'getValueProps', 'hasFeedback', 'help', 'htmlFor', 'id', 'initialValue', 'isListField', 'label', 'labelAlign', 'labelCol', 'normalize', 'preserve', 'required', 'tooltip', 'validateFirst', 'validateStatus', 'valuePropName', 'wrapperCol'])), /*#__PURE__*/React.createElement(FormItemLabel, _extends({
      htmlFor: fieldId,
      required: isRequired,
