...
var InternalAvatar = function InternalAvatar(props, ref) {
  ...
  var classString = classNames(prefixCls, sizeCls, _defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-").concat(shape), shape), "".concat(prefixCls, "-image"), src && isImgExist), "".concat(prefixCls, "-icon"), icon), className);
