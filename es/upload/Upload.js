...
var InternalUpload = function InternalUpload(props, ref) {
  ...
  var onSuccess = function onSuccess(response, file, xhr) {
    ...
    var targetItem = getFileItem(file, getFileList());
    // removed
    if (!targetItem) {
      return;
    }
  ...
  if (type === 'drag') {
    var dragCls = classNames(prefixCls, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-drag"), true), "".concat(prefixCls, "-drag-uploading"), getFileList().some(function (file) {
  ...
  var uploadButtonCls = classNames(prefixCls, _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-select"), true), "".concat(prefixCls, "-select-").concat(listType), true), "".concat(prefixCls, "-disabled"), disabled), "".concat(prefixCls, "-rtl"), direction === 'rtl'));
