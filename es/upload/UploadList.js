  ...
  var list = items.map(function (file) {
    ...
    if (listType === 'picture' || listType === 'picture-card') {
      if (file.status === 'uploading' || !file.thumbUrl && !file.url) {
        var uploadingClassName = classNames(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-list-item-thumbnail"), true), "".concat(prefixCls, "-list-item-file"), file.status !== 'uploading'));
    ...
    var infoUploadingClass = classNames(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-list-item"), true), "".concat(prefixCls, "-list-item-").concat(file.status), true), "".concat(prefixCls, "-list-item-list-type-").concat(listType), true));
    ...
    var listItemNameClass = classNames(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-list-item-name"), true), "".concat(prefixCls, "-list-item-name-icon-count-").concat([downloadIcon, removeIcon].filter(function (x) {
      return x;
    }).length), true));
