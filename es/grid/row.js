...
var Row = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var renderRow = function renderRow(_ref) {
    ...
    var classes = classNames(prefixCls, _defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-").concat(justify), justify), "".concat(prefixCls, "-").concat(align), align), "".concat(prefixCls, "-rtl"), direction === 'rtl'), className);
