...
var Alert = function Alert(_a) {
  ...
  var alertCls = classNames(prefixCls, "".concat(prefixCls, "-").concat(type), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-with-description"), !!description), "".concat(prefixCls, "-no-icon"), !isShowIcon), "".concat(prefixCls, "-banner"), !!banner), "".concat(prefixCls, "-closable"), isClosable), "".concat(prefixCls, "-rtl"), direction === 'rtl'), className);
