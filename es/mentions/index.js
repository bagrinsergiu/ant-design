...
var InternalMentions = function InternalMentions(_a, ref) {
  ...
  var mergedClassName = classNames(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-disabled"), disabled), "".concat(prefixCls, "-focused"), focused), "".concat(prefixCls, "-rtl"), direction === 'rtl'), className);
