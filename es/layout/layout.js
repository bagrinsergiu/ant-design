...
var BasicLayout = /*#__PURE__*/function (_React$Component2) {
  function BasicLayout() {
    ...
    _this2.renderComponent = function (_ref3) {
      ...
      var classString = classNames(prefixCls, _defineProperty(_defineProperty({}, "".concat(prefixCls, "-has-sider"), typeof hasSider === 'boolean' ? hasSider : _this2.state.siders.length > 0), "".concat(prefixCls, "-rtl"), direction === 'rtl'), className);
